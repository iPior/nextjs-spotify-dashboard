...
export default function ButtonTriplet(
  ...
  return (
    <div className="h-[20%] sm:h-[15%] 2xl:h-[10%]! pb-2 flex flex-col sm:flex-row md:flex-col xl:flex-row justify-center sm:justify-between md:justify-center xl:justify-between items-center">
      <div>
